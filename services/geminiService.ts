...
const getClient = () => {
  ...
  if (!apiKey) {
    throw new Error("API Key is missing. Please set process.env.GEMINI_API_KEY.""API Key is missing. Please set process.env.GEMINIAPI_KEY.""API Key is missing. Please set p  base64Image: string, 
