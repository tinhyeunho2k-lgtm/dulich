...
export const COUNTRIES: Country[] = [
  {
    ...
    name: 'Top Bãi Biển',
    flag: '🏝️',
    imageCover: 'https://images.unsplash.com/photo-1596895111956-bf1cf0599ce5?q=80&w=400&auto=format&fit=crop',
    destinations: [
      {
        id: 'maldives',
        name: 'Maldives',
        description: 'Thiên đường nghỉ dưỡng với biệt thự trên mặt nước.',
        imageUrl: 'https://images.unsplash.com/photo-1514282401047-d77a7149faf9?q=80&w=400&auto=format&fit=crop',
        promptContext: 'Standing on the wooden deck of a luxury overwater villa in the Maldives. Turquoise crystal clear water below. Sunny blue sky. Relaxed luxury vacation vibe.',
        isBeach: true
      },
      {
        id: 'bora_bora',
        ...
        imageUrl: 'https://images.unsplash.com/photo-1532408840135-cbf9660c14f1?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1566320091763-880907409249?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1535581652167-3d6b98636053?q=80&w=400&auto=format&fit=crop',
        promptContext: 'Standing on the cliff edge overlooking Kelingking Beach (T-Rex shape) in Nusa Penida, Bali. Dramatic cliff drop and deep blue ocean below. Windy travel adventurer vibe.',
        isBeach: true
      },
      {
        id: 'el_nido',
        ...
        imageUrl: 'https://images.unsplash.com/photo-1531761535209-180857e963b9?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1535579710123-3c0f261c474e?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1504730655668-71c4c114385a?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1589785237937-67c858547285?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1542259681-d4cd7093db29?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1548574505-5e239809ee19?q=80&w=400&auto=format&fit=crop',
  ...
  },
  {
    ...
    name: 'Việt Nam',
    flag: '🇻🇳',
    imageCover: 'https://images.unsplash.com/photo-1557750255-c76072a7aad1?q=80&w=400&auto=format&fit=crop',
    destinations: [
      {
        id: 'halong',
        name: 'Vịnh Hạ Long',
        ...
        promptContext: 'Standing casually on the wooden deck of a luxury cruise boat in Ha Long Bay. Background features iconic limestone karsts rising from green water under soft sunlight. Candid travel photo.',
        isBeach: true
      },
      {
        id: 'hoian',
        ...
        imageUrl: 'https://images.unsplash.com/photo-1545136894-399c2560cd8b?q=80&w=400&auto=format&fit=crop',
        promptContext: 'Walking on the street in Hoi An Ancient Town at twilight. Surrounded by glowing colorful silk lanterns and yellow heritage walls. Warm, nostalgic lighting.',
      },
      {
        id: 'goldenbridge',
        name: 'Cầu Vàng (Đà Nẵng)',
        description: 'Đứng giữa bàn tay khổng lồ trên mây.',
        imageUrl: 'https://images.unsplash.com/photo-1599708153386-53c8c9359a60?q=80&w=400&auto=format&fit=crop',
        promptContext: 'Standing on the Golden Bridge (Cau Vang) in Da Nang, held by giant stone hands. Cloudy, misty mountain atmosphere. High altitude view.',
      },
      {
        id: 'hanoi_train',
        name: 'Phố Đường Tàu Hà Nội',
        description: 'Uống cà phê bên đường ray độc đáo.',
        imageUrl: 'https://images.unsplash.com/photo-1595306786445-564344d32a9c?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1533550493867-b52f90240d12?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1583482276664-9ce5b35c05d7?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1565593886164-8898516ee892?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1506103301078-430b201657c9?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1590422915842-83b63297a06a?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1583766287998-382a89345c26?q=80&w=400&auto=format&fit=crop',
  ...
  },
  {
    ...
    name: 'Hàn Quốc',
    flag: '🇰🇷',
    imageCover: 'https://images.unsplash.com/photo-1538485399081-7191377e8241?q=80&w=400&auto=format&fit=crop',
    destinations: [
      {
        id: 'bukchon',
        name: 'Làng Hanok Bukchon',
        description: 'Dạo bước giữa những ngôi nhà cổ Seoul.',
        imageUrl: 'https://images.unsplash.com/photo-1563806203-d1434c4f3460?q=80&w=400&auto=format&fit=crop',
        promptContext: 'Walking uphill on a paved street in Bukchon Hanok Village, Seoul. Traditional Korean roofs on both sides. Blue sky. Quiet morning atmosphere.',
      },
      {
        id: 'gyeongbokgung',
        name: 'Cung điện Gyeongbokgung',
        description: 'Check-in cung điện hoàng gia.',
        imageUrl: 'https://images.unsplash.com/photo-1548115184-bc6544d06a58?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1627883265882-628d689658db?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1584883196885-b9e77609a365?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1535189043414-47a3c49a0bed?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1627481358983-5095d38b6d88?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1580139157209-51475c404eb5?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1601823984263-b87b5972c2c1?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1596489398565-d0532588c2b5?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1616149562385-1d84e79478bb?q=80&w=400&auto=format&fit=crop',
  ...
  },
  {
    ...
    name: 'Thái Lan',
    flag: '🇹🇭',
    imageCover: 'https://images.unsplash.com/photo-1506665531195-3566af2b4dfa?q=80&w=400&auto=format&fit=crop',
    destinations: [
      {
        id: 'wat_arun',
        name: 'Chùa Wat Arun',
        description: 'Biểu tượng Bangkok bên sông Chao Phraya.',
        imageUrl: 'https://images.unsplash.com/photo-1563492065599-3520f775eeed?q=80&w=400&auto=format&fit=crop',
        promptContext: 'Standing on the steps of the Wat Arun temple in Bangkok, detailed ceramic mosaic tiles visible. Blue sky. Bright sunlight.',
      },
      {
        id: 'phiphi',
        name: 'Đảo Phi Phi',
        description: 'Ngồi trên thuyền đuôi dài trứ danh.',
        imageUrl: 'https://images.unsplash.com/photo-1552465011-b4e21bf6e79a?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1505315055006-2594d4d673da?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1599543085675-9e66cb3a73c9?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1598218944583-04a43a0d1796?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1596791238697-74403310707a?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1569046049257-234b6e768393?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1583250682430-c4e9c70a93c7?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1549429188-e21dd9777df5?q=80&w=400&auto=format&fit=crop',
  ...
  },
  {
    ...
    name: 'Nhật Bản',
    flag: '🇯🇵',
    imageCover: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?q=80&w=400&auto=format&fit=crop',
    destinations: [
      {
        id: 'fuji_street',
        name: 'Phố nhìn ra núi Phú Sĩ',
        description: 'Góc phố Honcho nổi tiếng.',
        imageUrl: 'https://images.unsplash.com/photo-1490806843957-31f4c9a91c65?q=80&w=400&auto=format&fit=crop',
        promptContext: 'Walking down the famous Honcho Street in Fujiyoshida. Mount Fuji is looming huge and snow-capped at the end of the road. Retro signs, electric wires. Street photography style.',
      },
      {
        id: 'kyoto_torii',
        name: 'Cổng Torii (Kyoto)',
        description: 'Ngàn cổng đỏ tại Fushimi Inari.',
        imageUrl: 'https://images.unsplash.com/photo-1478436127897-769e1b3f0f36?q=80&w=400&auto=format&fit=crop',
        promptContext: 'Standing inside the tunnel of vermilion Torii gates at Fushimi Inari Shrine. Sunlight filtering through the orange gates. Mysterious and spiritual vibe.',
      },
      {
        id: 'shibuya',
        name: 'Ngã tư Shibuya',
        ...
        promptContext: 'Standing in the middle of the famous Shibuya Crossing scramble in Tokyo. Neon lights, large advertisements, crowds of people blurring in motion around. Cyberpunk city vibe.',
      },
      {
        id: 'osaka_dotonbori',
        name: 'Dotonbori (Osaka)',
        description: 'Check-in với biển hiệu Glico Man.',
        imageUrl: 'https://images.unsplash.com/photo-1590559399607-e009590dce64?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1505330622279-bf7d7fc918f4?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        promptContext: 'Standing in a park (Shiba Park) with the red and white Tokyo Tower rising majestically in the background. Blue sky and cherry blossoms if possible.',
      },
      {
        id: 'himeji_castle',
        name: 'Lâu đài Himeji',
        description: 'Lâu đài Hạc Trắng cổ kính.',
        imageUrl: 'https://images.unsplash.com/photo-1624823183496-0e9e4b679b38?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1545502648-5c4908a73562?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1560931139-44755106ee52?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1504109586057-7a2ae83d1338?q=80&w=400&auto=format&fit=crop',
  ...
  },
  {
    ...
    name: 'Pháp',
    flag: '🇫🇷',
    imageCover: 'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?q=80&w=400&auto=format&fit=crop',
    destinations: [
      {
        id: 'eiffel_cafe',
        name: 'Cafe Paris & Eiffel',
        description: 'Thưởng thức croissant view tháp Eiffel.',
        imageUrl: 'https://images.unsplash.com/photo-1511739001486-6bfe10ce7859?q=80&w=400&auto=format&fit=crop',
        promptContext: 'Sitting at a small round table on a balcony with a coffee and croissant. The Eiffel Tower is clearly visible in the near background. Romantic Parisian morning light.',
      },
      {
        id: 'louvre',
        name: 'Bảo tàng Louvre',
        description: 'Check-in trước kim tự tháp kính.',
        imageUrl: 'https://images.unsplash.com/photo-1499856871940-a09627c6dcf6?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1509439581779-6298f75bf6e5?q=80&w=400&auto=format&fit=crop',
        promptContext: 'Standing on the Champs-Élysées avenue with the massive Arc de Triomphe centered in the background. Busy Paris street life around, autumn leaves. Classic tourist shot.',
      },
      {
        id: 'mont_saint_michel',
        name: 'Mont Saint-Michel',
        description: 'Lâu đài cổ tích giữa biển.',
        imageUrl: 'https://images.unsplash.com/photo-1454178345722-e3251a37c442?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1549488346-60144d82b451?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1533630239268-c17244976453?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1534258936925-c48947b6bf02?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1501908740523-2680df1a5518?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1559569720-c659779df34d?q=80&w=400&auto=format&fit=crop',
  ...
  },
  {
    ...
    name: 'Trung Quốc',
    flag: '🇨🇳',
    imageCover: 'https://images.unsplash.com/photo-1508804185872-d7badad00f7d?q=80&w=400&auto=format&fit=crop',
    destinations: [
      {
        id: 'great_wall',
        name: 'Vạn Lý Trường Thành',
        description: 'Chinh phục kỳ quan thế giới.',
        imageUrl: 'https://images.unsplash.com/photo-1508804185872-d7badad00f7d?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1548919973-5cef591cdbc9?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1599661046289-e31897846e41?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1634300461311-66b6c023d6a2?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1526494631344-8c6fa6462917?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1621845112185-115df600b333?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1569668579737-2d4d985db574?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1545634563-7925e59c0379?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1527192491265-7301292080a9?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1547432415-1160d5b1285e?q=80&w=400&auto=format&fit=crop',
  ...
  },
  {
    ...
    name: 'Ý',
    flag: '🇮🇹',
    imageCover: 'https://images.unsplash.com/photo-1523906834658-6e24ef2386f9?q=80&w=400&auto=format&fit=crop',
    destinations: [
      {
        id: 'venice',
        name: 'Kênh đào Venice',
        description: 'Ngồi trên thuyền Gondola.',
        imageUrl: 'https://images.unsplash.com/photo-1514890547357-a9ee288728e0?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1552832230-c0197dd311b5?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1543835683-ec5466c688ee?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1515542622106-78bda8ba0e5b?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1633321088355-d0f811346df4?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1543429258-102553754c0b?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1579606829777-a892b152d11b?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1499678329028-101435549a4e?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1563829048035-779836173a38?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1531572753322-ad063cecc14f?q=80&w=400&auto=format&fit=crop',
  ...
  },
  {
    ...
    name: 'Mỹ',
    flag: '🇺🇸',
    imageCover: 'https://images.unsplash.com/photo-1485738422979-f5c462d49f74?q=80&w=400&auto=format&fit=crop',
    destinations: [
      {
        id: 'nyc_times_square',
        name: 'Times Square',
        description: 'Trung tâm New York sôi động.',
        imageUrl: 'https://images.unsplash.com/photo-1485738422979-f5c462d49f74?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1501594907352-04cda38ebc29?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1582650630663-e57833215904?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1474044159687-1ee9f03fd3f4?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1605833556294-ea5c7a74f57d?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1605130284535-11dd9eedc58a?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1502209877429-d7c6d9bc5732?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1512411606553-f726cb789279?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1535498730771-e735b998cd64?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1575408264798-b50d29e31746?q=80&w=400&auto=format&fit=crop',
  ...
  },
  {
    ...
    name: 'Vương Quốc Anh',
    flag: '🇬🇧',
    imageCover: 'https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?q=80&w=400&auto=format&fit=crop',
    destinations: [
      {
        id: 'big_ben_phone',
        name: 'Bốt điện thoại đỏ & Big Ben',
        description: 'Biểu tượng kinh điển của London.',
        imageUrl: 'https://images.unsplash.com/photo-1529655683826-aba9b3e77383?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1508866579294-878950c40608?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1454551433246-0b1d3d659543?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1599831633534-f2a89c8a9010?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1558273760-4927f8792019?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1589140228475-680c10b48455?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1520986606214-8b456906c813?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1565530751336-7c25c6dc8b09?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1486022643506-655513d6a275?q=80&w=400&auto=format&fit=crop',
  ...
  },
  {
    ...
    name: 'Thụy Sĩ',
    flag: '🇨🇭',
    imageCover: 'https://images.unsplash.com/photo-1530122037265-a5f1f91d3b99?q=80&w=400&auto=format&fit=crop',
    destinations: [
      {
        id: 'isletwald',
        name: 'Cầu tàu Iseltwald',
        description: 'Bối cảnh phim "Hạ cánh nơi anh".',
        imageUrl: 'https://images.unsplash.com/photo-1629854743475-6e0696b001d9?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1538356396654-20a2e55eb84d?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1493246507139-91e8fad9978e?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1563721345-4235e165d774?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1508115509939-5079a4054a10?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1499238302526-78b1f45c850d?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1598448834614-22b464223292?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1515488764276-beab7607c1e6?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1634994432095-2c8c634df344?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1574677271457-37b510c4a037?q=80&w=400&auto=format&fit=crop',
  ...
  },
  {
    ...
    name: 'Úc',
    flag: '🇦🇺',
    imageCover: 'https://images.unsplash.com/photo-1523482580672-01e6f063f9eb?q=80&w=400&auto=format&fit=crop',
    destinations: [
      {
        id: 'sydney_opera',
        name: 'Nhà hát Opera Sydney',
        description: 'Biểu tượng kiến trúc thế giới.',
        imageUrl: 'https://images.unsplash.com/photo-1624138784181-dc7f5b75e52e?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1566378246598-5b11a0d486cc?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1582967788606-a171f1080ca8?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1529108190281-9a4f620bc2d8?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1490218156170-07a829398f6d?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1505058925562-b9e763836151?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1596707328634-11883377264a?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1524820197278-540916411e20?q=80&w=400&auto=format&fit=crop',
  ...
  },
  {
    ...
    name: 'Ai Cập',
    flag: '🇪🇬',
    imageCover: 'https://images.unsplash.com/photo-1539650116455-251d9a044617?q=80&w=400&auto=format&fit=crop',
    destinations: [
      {
        id: 'pyramids_sphinx',
        name: 'Kim tự tháp & Nhân sư',
        description: 'Khám phá huyền bí ngàn năm.',
        imageUrl: 'https://images.unsplash.com/photo-1539650116455-251d9a044617?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1576014131795-d440191a8e8b?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1563804825656-7883d6a4c28f?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1566838318101-35f9927d3539?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1599388308801-447047f3f1e1?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1553913861-c0fdd5261b0c?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1503177119275-0aa32b3a9368?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        description: 'Khu chợ cổ nhất Cairo.',
        imageUrl: 'https://images.unsplash.com/photo-1576495370285-d8ec7676735e?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1568294657159-4d64024d9c4c?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1594895058727-b610c3c2f9e4?q=80&w=400&auto=format&fit=crop',
  ...
  },
   {
    ...
    name: 'Brazil',
    flag: '🇧🇷',
    imageCover: 'https://images.unsplash.com/photo-1483729558449-99ef09a8c325?q=80&w=400&auto=format&fit=crop',
    destinations: [
      {
        id: 'rio_christ',
        name: 'Tượng Chúa Cứu Thế',
        description: 'Ngắm toàn cảnh Rio de Janeiro.',
        imageUrl: 'https://images.unsplash.com/photo-1483729558449-99ef09a8c325?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1518182170546-0766be6f3740?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1563385732-c51d6be1e43c?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1566418304037-975949540b61?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1533596918803-518293998782?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1551699042-45e353273e72?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1571253013898-1e4334304892?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1577488339591-9c600109044d?q=80&w=400&auto=format&fit=crop',
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1596700085424-df3b36365f02?q=80&w=400&auto=format&fit=crop',
